...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Aonecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"aonecointools.com", "195.150.76.213"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"aonecointools.com", "testnet-seed.aonecointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Aonecoin is probably already running."), addrBind.ToString().c_str());
        else
